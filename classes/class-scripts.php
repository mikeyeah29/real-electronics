...
class Scripts {
	...
	public function enqueue_admin_styles(): void {
		...
		if (!in_array($screen->id, [ 'manufacturer_page_real-electronics-manufacturers', 'settings_page_real-electronics-global' ], true)) {
			return;
		}
	...
	public function enqueue_admin_scripts(string $hook): void {
		...
		if (!in_array($hook, [ 'manufacturer_page_real-electronics-manufacturers', 'settings_page_real-electronics-global' ], true)) {
			return;
		}
